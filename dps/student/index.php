...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <div class="row">
                <div class="col-sm-3 Box"><a href="myprofile.php"><i class="fas fa-user-tie fa-4x" ></i><br><br>MY PROFILE</a>
                </div>
                <div class="col-sm-3 Box"><a href="myattendance.php">
                ...
                <div class="col-sm-3 Box"><a href="myaccounts.php">
                ...
                <div class="col-sm-3 Box"><a href="mystudyMaterials.php">
                ...
                <div class="col-sm-3 Box"><a href="myTimeTable.php"><svg class="bi bi-table" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                ...
                <div class="col-sm-3 Box"><a href="libraryInfo.php">
                ...
                <div class="col-sm-3 Box"><a href="myexamination.php"><svg class="bi bi-calendar" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                ...
                <?php
                if($_SESSION['facility']=="HOSTEL"){
                    echo '<div class="col-sm-3 Box"><a href="myhostel.php"><svg class="bi bi-house" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                    ...
                    }elseif($_SESSION['facility']=="TRANSPORT"){
                    echo '<div class="col-sm-3 Box"><a href="mytransport.php"><svg class="bi bi-arrow-up-down" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-sm-3 Box"><a href="myenquiry.php"><svg class="bi bi-pencil-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
