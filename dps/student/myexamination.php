...
<head>
    ...
    <title><?php print "CLASS ".($_SESSION['class'])." Exam Schedule";?></title>
...
<div class="wrapper">
      <div id="content">
        ...
        <div class ="container " align="center">
            <h2 align="center"><?php print "CLASS ".($_SESSION['class']);?></h2>
            <?php $studentdatabase->examSchView("Class ".$_SESSION['class'])?>
        </div>
      </div>
  </div>
