      ...
      <div id="content">
        ...
        <?php
            if(isset($_GET['msg'])=="success")
                echo '<span class="msg">Your Equiry is Successfully Submitted !!!</span>';
            else if(isset($_GET['msg'])=="fail")
                echo '<span class="msg">Please Try Again !!!</span>';
        ...
        ?>
            ...
            <?php 
            $studentdatabase->myEnquiries($_SESSION['studentId'],$_SESSION['student']);
            ?>
        </div>
      </div>
  </div>
...
<div class="modal fade" id="newEnquiry" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <p> <span style="color:red;font-weight:bold">Note</span> : This Enquiry will be visible to ADMIN</p>
...
if(isset($_POST['resolve'])){
    ...
    $senderType=$_SESSION['student'];
    $senderId=$_SESSION['studentId'];

    $studentdatabase->MarkEnquiryResolved($eid,$senderType,$senderId);
}
...
if(isset($_POST['addBody']))
{
    ...
    $studentdatabase->addThisEnquiry($title,$body,$senderType,$senderId,$name);
}
?>