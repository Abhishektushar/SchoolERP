    <nav id="sidebar">
           ...
           <ul class="list-unstyled components">
                <p class="username"><a href="index.php"><?php echo $_SESSION['firstName']." ".$_SESSION['lastName'];?></a></p>
                ...
                <li>
                    <a href="myattendance.php">Attendance</a>
                </li>
                <li>
                    <a href="myaccounts.php">My Account</a>
                </li>
                <li>
                    <a href="mystudyMaterials.php">Study Material</a>
                </li>
                <li>
                    <a href="myTimeTable.php">Time Table</a>
                </li>
                <li>
                    <a href="libraryInfo.php">Library</a>
                </li>
                <li>
                    <a href="myexamination.php">Examination</a>
                </li>
                <?php 
                if($_SESSION['facility']=="HOSTEL"){
                echo '<li>
                        <a href="myhostel.php">Hostel</a>
                    </li>';
                }elseif($_SESSION['facility']=="TRANSPORT"){
                echo '<li>
                          <a href="mytransport.php">Transport</a>
                    </li>' ;
                }
                ?>
                <li>
                ...
                <li>
                    <a href="myenquiry.php">Enquiry</a>
                </li>
            </ul>
