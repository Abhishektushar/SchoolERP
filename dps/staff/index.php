...
<div class="container" align="center">
            <div class="row">
                ...
                <div class="col-sm-2 Box"><a href="students.php"><i class="fas fa-user-friends fa-4x"></i><br>STUDENT DETAILS</a></div>
                <div class="col-sm-2 Box"><a href="Profile.php"><i class="fas fa-user-tie fa-4x" ></i><br>MY PROFILE</a></div>
          <?php  if(isset($_SESSION['post_assigned']))
             if($_SESSION['post_assigned']==="Asst. Teacher"){
             echo '<div class="col-sm-2 Box"><a href="study_materials.php">
            ...
            echo'<div class="col-sm-2 Box"><a href="transport.php"><svg class="bi bi-arrow-up-down" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        if ($_SESSION['post']=="Lab Assistant"){
          echo '<div class="col-sm-2 Box"><a href="library.php">
               ...
               <div class="col-sm-2 Box"><a href="timetable.php"><svg class="bi bi-table" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                ...
                <div class="col-sm-2 Box"><a href="examination.php"><svg class="bi bi-calendar" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
  ...
  <?php if($_SESSION['post_assigned']==="Librarian" || $_SESSION['post_assigned']==="Asst. Teacher" ){
            echo'<div class="col-sm-2 Box"><a href="timetable.php"><svg class="bi bi-table" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                    <path fill-rule="evenodd" d="M14 1H2a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 001-1V2a1 1 0 00-1-1zM2 0a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V2a2 2 0 00-2-2H2z" clip-rule="evenodd"/>
                    <path fill-rule="evenodd" d="M15 4H1V3h14v1z" clip-rule="evenodd"/>
                    <path fill-rule="evenodd" d="M5 15.5v-14h1v14H5zm5 0v-14h1v14h-1z" clip-rule="evenodd"/>
                    <path fill-rule="evenodd" d="M15 8H1V7h14v1zm0 4H1v-1h14v1z" clip-rule="evenodd"/>
            ...
            echo '<div class="col-sm-2 Box"><a href="examination.php"><svg class="bi bi-calendar" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                    <path fill-rule="evenodd" d="M14 0H2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V2a2 2 0 00-2-2zM1 3.857C1 3.384 1.448 3 2 3h12c.552 0 1 .384 1 .857v10.286c0 .473-.448.857-1 .857H2c-.552 0-1-.384-1-.857V3.857z" clip-rule="evenodd"/>
                    <path fill-rule="evenodd" d="M6.5 7a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm-9 3a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm-9 3a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"/>
                    </svg><br>EXAMINATION</a>
                </div>';   }?>
            ...
            echo '<div class="col-sm-2 Box"><a href="library.php">
                ...
                <?php if($_SESSION['post_assigned']==="Asst. Teacher"){
            echo'<div class="col-sm-2 Box"><a href="attendance.php">
                ...
                echo '<div class="col-sm-2 Box"><a href="Hostel.php"><svg class="bi bi-house" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                ...
                <div class="col-sm-2 Box"><a href="Enquiry.php"><svg class="bi bi-pencil-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
