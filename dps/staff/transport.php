       ...
       <?php include "includes/sidebar.php" ?>
        ...
        <div id="content">
            ...
            <a href="#" data-toggle="modal" data-target="#add_route">
                <button type="button" style="float:right" class="btn btn-success">Add Route</button></a>
            <h2>ROUTES</h2></br>
            <div class="table-responsive">
                 <table class="table table-hover">
                    ...
                    <tbody style="text-align: left;">
                     <?php
                      $staffdatabase->getRouteList($_SESSION['post']);
                      ?>
                    </tbody>
                  </table>  
              </div>  
      ...
      <div class="modal-body">
       <form method="POST">
        ...
        <label for="feeDetails">TRANSPORT FEES</label>
            <input type="text" class="form-control" id="feeDetails" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="feeDetails" value="<?php print $staffdatabase->facilityfees("TRANSPORT")?>" required>
     </div></br>
...
<?php include "transport/addRoute.php"?>
  <?php include "includes/lowerHtml.php"?>
    ...
    if(isset($_POST["change"])){
        ...
        $staffdatabase->changeFacilityFees("TRANSPORT",$val,"transport",$_SESSION["post"]);
    }
    ?>