...
?>
<?php
  if(!$staffdatabase->validateBookcnt($_GET["id"],$_SESSION['post_assigned']))
     header("location:../../");
                ...
                <form id="bookForm" method="POST">
                  <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                        <?php $get=$staffdatabase->editbookdetails($_GET["id"])?>
...
<!--End of Form Content -->
  ...
  $staffdatabase->updateBookInfo($_SESSION['post_assigned'],$bid,$bname,$sub,$copies,$publication,$author,$YOP,$pubCon,$changeId);
}
 
if(isset($_POST['YconfrmDel'])){
    $staffdatabase->RemoveThisBook($_GET['id'],$_SESSION['post_assigned']);
}
