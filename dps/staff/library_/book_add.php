                ...
                <form id="bookForm" method="POST">
                  ...
                  <div class="form-row">
                      ...
                      <label for="copies"><i>Copies</i></label>
                          <input type="number" class="form-control" id="copies" name="copies" oninput="this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="Number of Copies" required >
                      </div>
                      <span class="form-group col-md-2"></span>
                  </div>
...
<!--End of Form Content -->
  ...
  $staffdatabase->addNewBook($_SESSION['post_assigned'],$bid,$bname,$sub,$copies,$publication,$author,$YOP,$pubCon);
}
  ?>