...
<head>
    ...
    <title><?php print $staffdatabase->routeName($_GET['id']);?></title>
...
<body>
    <div class="wrapper">
        ...
        <div class="jumbotron" style="width : 85%;margin: auto"><h3 align="center"><u>Route Information</u></h3><?php $staffdatabase->routeInfo($_GET['id'],$_SESSION['post'])?></div>
</br>
            ...
            <div class="table-responsive">
             <table class="table table-hover">
                    ...
                    <tbody style="text-align: left;">
                            ...
                            <?php $staffdatabase->transport_student_list($_GET['id'],$_SESSION['post']);?>
...
if(isset($_POST["delete-student"]))
{
    ...
    $staffdatabase->removethisStudentFrmRoute($stdnt,$_GET['id'],$_SESSION['post']);
}
?>