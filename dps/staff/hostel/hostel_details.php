...
<head>
    ...
    <title><?php $hostel_id=$_GET['ref'];$staffdatabase->getHostelName($hostel_id,$_SESSION['post']);?></title>
...
<body>
    <div class="wrapper">
        ...
        <h3 align="center"><?php $staffdatabase->getHostelName($hostel_id,$_SESSION['post']);?></h3></br></br>
        ...
        <table class="table table-hover">
                   ...
                   <?php $staffdatabase->displayStudentInHostel($hostel_id,$_SESSION['post'])?>
                    </tbody>
                  </table>  
                  <?php
            if(isset($_POST['delete-student'])){
                    ...
                    $hostel=$hostel_id;
                    $staffdatabase->delete_Student($delete,$hostel,$_SESSION['post']);                  
            }?>
            </form></div>
        </div>
...
<div id="edit" class="modal fade" role="dialog">
  <div class="modal-dialog"> 
    ...
    <input type="text" class="form-control" id="hostel_name" name="hostel_name" value="<?php print $staffdatabase->getHostelName($_GET['ref'],$_SESSION['post'])?>"required>    
...
<?php
    if(isset($_POST["edit_name"]))
    {
        ...
        $staffdatabase->ChangeHostelName($_GET['ref'],$name,$_SESSION['post']);
    }
?>