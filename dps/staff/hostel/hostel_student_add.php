<div id="addStudentToHostel" class="modal fade" role="dialog">
  <div class="modal-dialog"> 
    ...
    <div class="modal-content" align="left">
     ...
     <h4 align="center"><?php $staffdatabase->getHostelName($_GET['ref'],$_SESSION['post']);?></h4>
	 </div></br>
     ...
     <div class="form-group">
        ...
        <?php $staffdatabase->hostel_studentADD_list($_GET['ref'],$_SESSION['post']);?></select>
      </div>
...
$hid=strip_tags($_GET['ref']);
$staffdatabase->addStudentToHostel($sid,$hid,$_SESSION['post']);}
?>
