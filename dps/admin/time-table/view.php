...
<head>
    ...
    <title><?php print ($_GET['class'])." Routine";?></title>
...
<div class="wrapper">
      <div id="content">
        ...
        <div class ="container" align="center" >
            ...
            <span id="getMsg"></span>
            <?php $database->viewMyTimeTable($_GET['class'])?>
        </div>
      </div>
  </div>
        <!---this model is for updating TIme Table--->
    <div id="update-timetable" class="modal fade" role="dialog">
    <div class="modal-dialog">
>
        <div class="modal-co
        <!-- Modal content--ntent" align="left">
        ...
        <div class="form-group">
            <label for="select-class">You are changing time table of <strong> <?php print ($_GET['class']);?> </strong></label>
        </div>
        ...
        <button type="submit" name="updateTable" class="btn btn-success">Submit</button></form>
  ...
  {    
      ...
      $database->updateTimeTable($fileName, $fileError, $fileSize, $fileTmpName,$class);  
  }
?>     
