...
if(!isset($_SESSION['admin']))  
    header("location:../../");
?>
<?php $fetch=$database->getThisStudentDetails($_GET['id']);?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title><?php $database->getStudentName($_GET['id']);?></title>
...
<body>
    <div class="wrapper">
        ...
        <div style="font-size: 16px;">
            ...
            <div class='jumbotron'> <a href="edit_details.php?id=<?php print $_GET['id']?>"><button class="btn btn-sm btn-warning" style="float:right">EDIT ME</button></a>
