                     ...
                     <div class="input-group">   
                          <select class="form-control" id="class" name="class" >
                                <option value="">---Select Class---</option><?php $i=1;while($i<=12){
                                            echo"<option value='".$i."'>CLASS ".$i."</option>";$i++;}?>   
                           </select>  
...
<?php
    if(isset($_POST["class-search-btn"]))
    {
        ...
        echo '<script>location.href="attendance/class_attendance.php?class='.$class.'"</script>' ;
    }

    if(isset($_POST["search-btn"]))
    {
        $sid=strip_tags($_POST["studentID"]);
        echo '<script>location.href="attendance/student_attendance.php?sid='.$sid.'"</script>' ;
    }
