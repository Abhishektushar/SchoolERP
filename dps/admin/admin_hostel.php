            ...
            <div class="container" >
                    <div class="row" >
                            <a href="hostel/hostel_details.php?ref=1">
                                <div class="col-sm-3 box1 Box"><?php $database->getHostelName(1)?></div></a>
                            <a href="hostel/hostel_details.php?ref=2">
                                <div class="col-sm-3 box2 Box"><?php $database->getHostelName(2)?></div></a>
                            <a href="hostel/hostel_details.php?ref=3">
                                <div class="col-sm-3 box3 Box"><?php $database->getHostelName(3)?></div></a>
                    </div>
             </div>         
        </div>        
        </div>
      ...
      <div class="modal-body">
       <form method="POST">
        ...
        <label for="feeDetails">HOSTEL FEES</label>
            <input type="text" class="form-control" id="feeDetails" name="feeDetails" value="<?php print $database->facilityfees("HOSTEL")?>" required>
     </div></br>
<button type="submit" name="change" class="btn btn-success">Submit</button></form>
    ...
    if(isset($_POST["change"])){
        if(is_numeric($_POST["feeDetails"]))
       { $val=strip_tags($_POST["feeDetails"]);
        $database->changeFacilityFees("HOSTEL",$val,"admin_hostel");
        }else{
