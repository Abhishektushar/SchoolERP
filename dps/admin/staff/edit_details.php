...
<div class="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <?php $fetch=$database->getStaffDetails($_GET['id']);?>
              <h4 class="sub-heading" align="center">Edit <strong><?php print $fetch["FirstName"]." ".$fetch["MiddleName"]." ".$fetch["LastName"];?></strong> Details</h4><div class="line"></div>
        <div class="container">
                ...
                <div class="container">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control" name="lastName" maxlength="15" value="<?php print $fetch['LastName']?>">
                    </div>
                  </div>
                ...
                <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" maxlength="15" name="nationality" value="<?php print $fetch["nationality"]?>"> 
                </div>
...
<!--       end of basic detail container        -->
                ...
                <div class="form-row">
                      <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" maxlength="8" name="house_number" value="<?php print $fetch["house_number"]?>">
                        </div>
                    <span class="form-group col-md-4"></span>
                        <div class="form-group col-md-4">
                        <label for="inputAddress2">Locality</label>
                        <input type="text" class="form-control" maxlength="35" name="locality" maxlength="50" value="<?php print $fetch["locality"]?>">
                      </div>
                </div>        
                  <div class="form-row">
                       <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" maxlength="15" id="City" name="city" value="<?php print $fetch["city"]?>">
                    </div>
                ...
                <div class="container">
                    <div class="form-row">  
                      ...
                      <input type="text" class="form-control" maxlength="25" name="relation_name" value="<?php print $fetch["relation_name"]?>">
                    </div>
                    </div>
                </div>
                 ...
                 <div class="container">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-9">
                                <input type="text" class="form-control"  name="grad_name" maxlength="20"  value="<?php print $fetch["grad_name"]?>">  
                            </div>
                            ...
                            <div class="form-group col-md-9">
                                <input type="text" class="form-control" maxlength="25"  name="grad_university"  value="<?php print $fetch["grad_university"]?>">
                            </div>
                    ...
                    <div id="showMore" class="showMore form-group col-md-9">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control" maxlength="20"  name="otherQuali_Name"  value="<?php print ($fetch["otherQuali_name"])?$fetch["otherQuali_name"]:"NULL"?>">  
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control" maxlength="25" id="otherQuali_University" name="otherQuali_University" value="<?php print ($fetch["otherQuali_university"])?$fetch["otherQuali_university"]:"NULL"?>">
                            </div>
                ...
                <div class="form-row">
                   ...
                   <div class="form-row">
                    <div class="form-group col-md-3">
                      ...
                      <select id="staff" class="form-control" name="Sch_Pos" onchange="showSelect('typeOfPost',this)" >
                    ...
                    <div class="form-group col-md-3" id="typeOfPost" onchange="showSubAssigned('subAssigned',this)" style="display:<?php print ($fetch["post_assigned"])?'block !important':'none'?>" >
                        <label for="typeOfPost">Type Of Post</label>
                              
                                  <select id="PostType" class="form-control" name="Sch_Post">
                                    <option value="<?php print $fetch["post_assigned"]?>"><?php print $fetch["post_assigned"]?></option>
                                  </select>
                              
                    </div>
                   
                   <div class="form-group col-md-3" id="subAssigned" onchange="showClass('classAssign')" style="display:<?php print ($fetch["subject_assigned"])?'block !important':'none'?>">
                    ...
                    <div class="form-group col-md-3" id="classAssign" style="display:<?php print ($fetch["class_assigned"])?'block !important':'none'?>" >
                                <label for="classAssign">Assign Classes</label><br>
                                  <span><?php print ($fetch["class_assigned"])?"ASSIGNED : ".$fetch["class_assigned"]:"NO CLASS ASSIGNED<br>AGAIN ASSIGN DESIGNATED CLASSES"?></span>
                                   <input type="text" name="AssignedClass" class="form-control"value="<?php print $fetch["class_assigned"];?>">
  ...
  <script src="../admission/js/staff.js"></script>
...
<?php
    if(isset($_POST['submitChanges']))
    {
      ...
      $classes_assigned=strip_tags($_POST['AssignedClass']);
      
      $database->updateThisStaffDetails($_GET['id'],$firstName,$middleName,$lastName,$DOB,$blood_grp,$nationality,
