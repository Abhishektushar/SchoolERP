    <nav id="sidebar">
           ...
           <ul class="list-unstyled components">
                <p class="username"><a href="index.php"><?php echo $_SESSION['admin']?></a></p>
               ...
               <li>
                ...
                <li>
                    <a href="admin_study_materials.php">Study Material</a>
                </li>
                <li>
                    <a href="admin_accounting.php">Accounting</a>
                </li>
                <li>
                    <a href="admin_transport.php">Transport</a>
                </li>
                <li>
                ...
                <li>
                    <a href="admin_examination.php">Examination</a>
                </li>
                <li>
                    <a href="admin_attendance.php">Attendance</a>
                </li>
                <li>
                    <a href="admin_hostel.php">Hostel</a>
                </li>
                <li>
                    <a href="admin_notice.php">Notice</a>
                </li>
                <li>
                    <a href="admin_enquiry.php">Enquiry</a>
                </li>
            </ul>

          <a href="admin_setting.php"> <span class="chngp"><svg class="bi bi-gear" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
